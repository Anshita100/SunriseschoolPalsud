      ...
      <div className="flex flex-col md:flex-row gap-6 px-6 md:px-16 lg:px-24 py-12">
        ...
        <div className="md:w-3/4">
          ...
          <p className="mb-6 text-gray-700 dark:text-gray-300">
            Our pedagogy blends traditional wisdom with modern approaches. By
            focusing on every child’s individual potential, we create
            personalized pathways for academic excellence and holistic growth.
            The learning environment is warm, inclusive, and nurturing.
          </p>
          ...
          <p className="mb-6 text-gray-700 dark:text-gray-300">
            Rooted in our vision, we believe that education must empower
            students to innovate, explore, and engage with the world around
            them. We strive to develop leadership, compassion, and
            self-awareness in every learner through curriculum and co-curricular
            balance.
          </p>
          ...
          <p className="mb-10 text-gray-700 dark:text-gray-300">
            Our classrooms are vibrant hubs of creativity, collaboration, and
            inquiry. We integrate skill-based learning across disciplines to
            prepare students for a fast-changing world, fostering adaptability,
            digital literacy, and problem-solving capabilities.
          </p>
          ...
          <div className="space-y-4 mb-10">
            {pedagogyHighlights.map((item, index) => (
              <div
                key={index}
                className="border border-blue-300 dark:border-blue-700 rounded-lg"
              >
                <button
          ...
          <p className="mb-10 text-gray-700 dark:text-gray-300">
            We emphasize student voice and choice in learning. From selecting
            research topics to designing projects, learners are involved in
            their educational journey. We aim to cultivate ownership, curiosity,
            and agency.
          </p>
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            We constantly evaluate our strategies and practices based on
            feedback from educators, parents, and students. Our teachers
            participate in ongoing training and workshops to refine their skills
            and adopt innovative teaching methods.
          </p>
        </div>
      </div>
